...
export const armcareExamsPlayerIdx = index("armcare_exams_player_idx").on(
  armcareExams.playerId
);

export const armcareExamsDateIdx = index("armcare_exams_date_idx").on(
  armcareExams.examDate
);
...
export const armcareExamsUnmatchedPlayerIdx = index(
  "armcare_exams_unmatched_player_idx"
).on(armcareExamsUnmatched.externalPlayerId);
