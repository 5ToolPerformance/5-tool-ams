  ...
  const [strengthRows, hittraxRows, blastRows] = await Promise.all([
    db
      .select({
        ...
        plyoPushup: evaluationsStrength.plyoPushup,
        seatedShoulderErL: evaluationsStrength.seatedShoulderErL,
        seatedShoulderErR: evaluationsStrength.seatedShoulderErR,
        seatedShoulderIrL: evaluationsStrength.seatedShoulderIrL,
        seatedShoulderIrR: evaluationsStrength.seatedShoulderIrR,
        cmj: evaluationsStrength.cmj,
        cmjPropulsiveImpulse: evaluationsStrength.cmjPropulsiveImpulse,
        cmjPeakPower: evaluationsStrength.cmjPeakPower,
        pogoJump: evaluationsStrength.pogoJump,
        dropJump: evaluationsStrength.dropJump,
        midThighPull: evaluationsStrength.midThighPull,
        midThighPullTtpf: evaluationsStrength.midThighPullTtpf,
        netForce100ms: evaluationsStrength.netForce100ms,
        shotPut: evaluationsStrength.shotPut,
        scoopToss: evaluationsStrength.scoopToss,
      })
    ...
    db
      .select({
        ...
        powerAvg: evaluationBlast.powerAvg,
      })
  ...
  return buildPlayerPerformanceData({
    strengthRows: strengthRows.map((row) => ({
      ...
      metrics: {
        ...
        plyoPushup: row.plyoPushup,
        seatedShoulderErL: row.seatedShoulderErL,
        seatedShoulderErR: row.seatedShoulderErR,
        seatedShoulderIrL: row.seatedShoulderIrL,
        seatedShoulderIrR: row.seatedShoulderIrR,
        cmj: row.cmj,
        cmjPropulsiveImpulse: row.cmjPropulsiveImpulse,
        cmjPeakPower: row.cmjPeakPower,
        pogoJump: row.pogoJump,
        dropJump: row.dropJump,
        midThighPull: row.midThighPull,
        midThighPullTtpf: row.midThighPullTtpf,
        netForce100ms: row.netForce100ms,
        shotPut: row.shotPut,
        scoopToss: row.scoopToss,
      },
    })),
