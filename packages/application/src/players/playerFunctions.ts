...
import { MotorPreferencesForm } from "@ams/contracts/types/assessments";
import { PlayerInsert } from "@ams/db/types/database";
   ...
   */
export async function getPlayerInformationById(playerId: string) {
    try {
   ...
   */
export async function createPlayerInformation(data: PlayerInsert) {
   ...
   */
export async function updatePlayerInformation(
    playerId: string,
   ...
   */
export async function createMotorPreferences(data: MotorPreferencesForm) {
    try {
   ...
   */
export async function getMotorPreferencesById(playerId: string) {
    try {
   ...
   */
export async function getAllPlayersWithInformation() {
    try {
...
export async function getPlayerByIdScoped(playerId: string, facilityId: string) {
    try {
      const [player] = await db
        .select()
        .from(playerInformation)
...
export async function getAllPlayersWithInformationScoped(facilityId: string) {
    try {
      return await db
        .select()
        .from(playerInformation)
