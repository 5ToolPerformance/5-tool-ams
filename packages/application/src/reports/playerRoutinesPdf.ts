import type { PlayerRoutinesPdfData } from "@/application/players/development/getPlayerRoutinesPdfData";
...
export function getPlayerRoutinesPdfHtml(
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>${escapeHtml(data.player.name)} Routines</title>
        <style>
        ...
        <article class="routine-report-document">
          ...
          <div class="routine-report-content">
            <header class="routine-report-header">
              <div class="routine-report-eyebrow">Player Routine Export</div>
                ...
                <div class="routine-report-header-aside">
                  ...
                  ${
                    data.player.primaryCoachName
                      ? `<div>Coach ${escapeHtml(data.player.primaryCoachName)}</div>`
                      : ""
                  }
                </div>
              </div>
              <div class="routine-report-meta">
                ...
                <div class="routine-report-meta-item">
                  ...
                  <strong>${escapeHtml(String(data.routines.length))}</strong>
                </div>
              </div>
            </header>
