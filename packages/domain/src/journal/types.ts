...
export type JournalContextType = (typeof JOURNAL_CONTEXT_TYPES)[number];
export type ThrowType = (typeof THROW_TYPES)[number];
export type ThrowIntent = (typeof THROW_INTENTS)[number];
export type HittingOutcome = (typeof HITTING_OUTCOMES)[number];
export type WorkloadQuality = (typeof WORKLOAD_QUALITIES)[number];
