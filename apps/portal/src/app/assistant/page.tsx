...
export default async function PortalAssistantPage({
  ...
  return (
    <div className="mx-auto max-w-md space-y-4 px-4 py-5">
      ...
      <Card className="border border-amber-300/50 bg-white/85 dark:border-amber-200/10 dark:bg-default-100/70">
        <CardBody className="space-y-3 p-5">
          <h1 className="text-2xl font-semibold">AI Assistant</h1>
          <p className="text-sm text-default-500">
            AI assistant features are coming soon{selectedPlayer ? ` for ${selectedPlayer.fullName}` : ""}.
          </p>
          <p className="text-sm text-default-500">
            This area will let parents ask questions about development, routines, and progress.
          </p>
        </CardBody>
      </Card>
    </div>
