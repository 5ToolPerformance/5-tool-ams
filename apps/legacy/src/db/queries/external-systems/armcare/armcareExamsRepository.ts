 ...
 */
   ...
   */
export async function getUnmatchedExams() {
    try {
...
export async function getUnmatchedPlayers() {
   ...
   * @throws Error if there is an error with the database query
   */
export async function linkArmcarePlayer(
    externalPlayerId: string,
    pathPlayerId: string,
   ...
   * @throws Error if there is an error with the database query
   */
export async function getPlayerExams(playerId: string) {
    try {
...
export async function getExamById(examId: string) {
   ...
   * @throws Error if there is an error with the database query
   */
export async function getLatestPlayerExam(playerId: string) {
    try {
      const exam = await db.query.armcareExams.findFirst({
        where: eq(armcareExams.playerId, playerId),
        orderBy: desc(armcareExams.examDate),
...
export async function getPlayerSummary(playerId: string) {
   ...
   */
export async function getLatestPlayerArmScore(playerId: string) {
    try {
      const exam = await db.query.armcareExams.findFirst({
        where: and(
