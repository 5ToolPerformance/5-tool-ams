...
jest.mock("@ams/application/admin/weeklyUsageReport/generateWeeklyUsageReports", () => ({
...
const { generateWeeklyUsageReports } = require("@ams/application/admin/weeklyUsageReport/generateWeeklyUsageReports");
