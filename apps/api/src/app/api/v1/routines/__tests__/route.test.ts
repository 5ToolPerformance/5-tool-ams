...
import { updateRoutine } from "@ams/application/routines/updateRoutines";
import { getDevelopmentPlanById } from "@ams/db/queries/development-plans/getDevelopmentPlanById";
import { getRoutineById } from "@ams/db/queries/routines/getRoutineById";
import {
  assertPlayerAccess,
  getAuthContext,
  requireRole,
...
jest.mock("@ams/application/routines/createRoutine", () => ({
  createRoutine: jest.fn(),
}));
jest.mock("@ams/application/routines/updateRoutines", () => ({
  updateRoutine: jest.fn(),
}));
jest.mock("@ams/db/queries/development-plans/getDevelopmentPlanById", () => ({
  getDevelopmentPlanById: jest.fn(),
}));
jest.mock("@ams/db/queries/routines/getRoutineById", () => ({
